...
function ProteinsByThePound() {
  ...
  const buttonLbs = ["1 lbs", "2 lbs", "3 lbs"];
            ...
            <div className={styles.pack}>
              <div className={styles.packHeading}>
                <div className={styles.packHeadingLeftSection}>
                  ...
                  <RiQuestionFill
                    style={{ paddingTop: "8px", color: "#243843" }}
                    size={"35px"}
                  />
                </div>
                    ...
                    {buttonLbs.map((val, i) => {
                      return (
                        <div
                          className={styles.card}
                          onClick={() => {
                            handleProteinsLbs(caloriesData, val);
                          }}
                          key={i}
                        >
                          {val}
                  ...
                  <div className={styles.carbsContainer}>
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        <h3>Calories</h3>
                        {caloriesData.calories.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.calories.num !== ""
                              ? proteinDataLbs.calories.num
                              : caloriesData.calories.num
                            ).toFixed(2)}
                            cal
                            <span>
                              (
                              {proteinDataLbs.calories.percentage !== ""
                                ? proteinDataLbs.calories.percentage
                                : caloriesData.calories.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        <h3>Total Fat</h3>
                        {caloriesData.totalFat.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.totalFat.num !== ""
                              ? proteinDataLbs.totalFat.num
                              : caloriesData.totalFat.num
                            ).toFixed(2)}
                            cal
                            <span>
                              (
                              {proteinDataLbs.totalFat.percentage !== ""
                                ? proteinDataLbs.totalFat.percentage
                                : caloriesData.totalFat.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsSlimText}>
                      <div className={styles.text}>
                        <h3>Saturated Fat</h3>
                        {caloriesData.saturatedFat.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.saturatedFat.num !== ""
                              ? proteinDataLbs.saturatedFat.num
                              : caloriesData.saturatedFat.num
                            ).toFixed(2)}
                            gr
                            <span>
                              (
                              {proteinDataLbs.saturatedFat.percentage !== ""
                                ? proteinDataLbs.saturatedFat.percentage
                                : caloriesData.saturatedFat.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        <h3>Cholestrol</h3>
                        {caloriesData.cholestrol.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.cholestrol.num !== ""
                              ? proteinDataLbs.cholestrol.num
                              : caloriesData.cholestrol.num
                            ).toFixed(2)}
                            mg
                            <span>
                              (
                              {proteinDataLbs.cholestrol.percentage !== ""
                                ? proteinDataLbs.cholestrol.percentage
                                : caloriesData.cholestrol.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        <h3>Sodium</h3>
                        {caloriesData.sodium.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.sodium.num !== ""
                              ? proteinDataLbs.sodium.num
                              : caloriesData.sodium.num
                            ).toFixed(2)}
                            mg
                            <span>
                              (
                              {proteinDataLbs.sodium.percentage !== ""
                                ? proteinDataLbs.sodium.percentage
                                : caloriesData.sodium.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        ...
                        {caloriesData.totalCarbs.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.totalCarbs.num !== ""
                              ? proteinDataLbs.totalCarbs.num
                              : caloriesData.totalCarbs.num
                            ).toFixed(2)}
                            gr
                            <span>
                              (
                              {proteinDataLbs.totalCarbs.percentage !== ""
                                ? proteinDataLbs.totalCarbs.percentage
                                : caloriesData.totalCarbs.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsSlimText}>
                      <div className={styles.text}>
                        <h3>Dietry Fiber</h3>
                        {caloriesData.dietryFibres.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.dietryFibres.num !== ""
                              ? proteinDataLbs.dietryFibres.num
                              : caloriesData.dietryFibres.num
                            ).toFixed(2)}
                            gr
                            <span>
                              (
                              {proteinDataLbs.dietryFibres.percentage !== ""
                                ? proteinDataLbs.dietryFibres.percentage
                                : caloriesData.dietryFibres.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsSlimText}>
                      <div className={styles.text}>
                        <h3>Total Sugars</h3>
                        {caloriesData.totalSugars.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.totalSugars.num !== ""
                              ? proteinDataLbs.totalSugars.num
                              : caloriesData.totalSugars.num
                            ).toFixed(2)}
                            gr
                            <span>
                              (
                              {proteinDataLbs.totalSugars.percentage !== ""
                                ? proteinDataLbs.totalSugars.percentage
                                : caloriesData.totalSugars.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsSlimText}>
                      <div className={styles.text}>
                        ...
                        {caloriesData.includedSugars.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.includedSugars.num !== ""
                              ? proteinDataLbs.includedSugars.num
                              : caloriesData.includedSugars.num
                            ).toFixed(2)}
                            gr
                            <span>
                              ...
                              {proteinDataLbs.includedSugars.percentage !== ""
                                ? proteinDataLbs.includedSugars.percentage
                                : caloriesData.includedSugars.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
                    ...
                    <div className={styles.carbsBoldText}>
                      <div className={styles.text}>
                        <h3>Protein</h3>
                        {caloriesData.protein.num !== "" ? (
                          <h3>
                            {(proteinDataLbs.protein.num !== ""
                              ? proteinDataLbs.protein.num
                              : caloriesData.protein.num
                            ).toFixed(2)}
                            gr
                            <span>
                              (
                              {proteinDataLbs.protein.percentage !== ""
                                ? proteinDataLbs.protein.percentage
                                : caloriesData.protein.percentage}
                              %)
                            </span>
                          </h3>
                        ) : (
