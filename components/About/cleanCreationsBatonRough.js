        ...
        return (
            <div>
                <div className="px-5">
                    ...
                    <p className="text-3xl font-bold text-gray-700 mt-5">Sushil Creation, Baton Rouge: FAQs</p>
                    <p className=" text-gray-700">Having healthy, delicious meals prepared for you by Sushil Creation, Baton Rouge sounds great - but <span className="font-bold">how do you get started</span>? All you have to do is click the “<Link className="no-underline cursor-pointer" href="/">Get Started</Link>” link on our homepage to set up an account. Once you create a profile, you can then visit the “Order” tab on our homepage to begin placing your order. It’s as easy as that!</p>
                    <p className=" text-gray-700">We also get a lot of questions about how our meal plans work, such as <span className="font-bold">are meal plans recurring</span>? The answer is yes. Our meal plans are subscriptions, and we charge you weekly, biweekly, or monthly based on your preferences. Customers also wonder: <span className="font-bold">can I choose my own meals</span>? Absolutely! We pride ourselves on preparing a wide variety of delicious, nutritious meals, allowing you to dictate your own meal plan. You get to choose your subscription meals before your initial checkout, and again after the account auto-renews. Even if you don’t have a subscription plan, your meals can be chosen under the “a la carte” ordering section. Customers also ask questions like “Do I have to order a meal plan?” Nope!  Meal plans are just one of the options we offer in addition to a la carte, bulk, or via our custom meal builder. With these last three options, you just receive food when you place an order. If you need to cancel an order due to unforeseen circumstances or vacation time, send all cancellation requests to customerservice@bookonepos.net.</p>
                    <p className=" text-gray-700">If you’re located in the Baton Rouge area, you might be wondering: Can I get delivery to the Baton Rouge area? And while we’re not offering delivery just yet, we do offer pick-up for our Sushil Creation Baton Rouge customers. You can pick up your meals at our Perkins Road East location. Our Sushil Creation Baton Rouge orders are available for pick up every Sunday and Wednesday every week after 12:00 PM. If you’d like more information about the Sushil Creation Baton Rouge operation, please give us a call.</p>
                    <p className="text-3xl font-bold text-gray-700">Make Healthy Eating a Breeze with Sushil Creation, Baton Rouge</p>
                    <p className=" text-gray-700">Maintaining a healthy lifestyle when you have a busy schedule can be exhausting. From meal planning to grocery shopping to preparing the food, eating right takes time. But with Sushil Creation, Baton Rouge, we make healthy eating a breeze! Not only do we hand-select the freshest ingredients for your meals, but we also do all the cooking, cleaning up, and packaging for you. And better yet, you get to pick from our current menu, tailoring your meal plan to your palate. To help you eat healthy on a time crunch, Sushil Creation provides you with fresh, healthy meals delivered right to your door or for pickup at our New Orleans or Baton Rouge locations. Eating well has never been more convenient with our large selection of meal plans and à la carte options. Sign up for Sushil Creation today to start your healthy eating journey today!</p>
                    <div className="grid place-content-center">
