        ...
        return (
            <div>
                <div className="px-5">
                    ...
                    <p className="text-3xl font-bold text-gray-700 mt-5">BookOnePos, Baton Rouge: FAQs</p>
                    <p className=" text-gray-700">Having healthy, delicious meals prepared for you by BookOnePos, Baton Rouge sounds great - but <span className="font-bold">how do you get started</span>? All you have to do is click the “<Link className="no-underline cursor-pointer" href="/">Get Started</Link>” link on our homepage to set up an account. Once you create a profile, you can then visit the “Order” tab on our homepage to begin placing your order. It’s as easy as that!</p>
                    ...
                    <p className=" text-gray-700">If you’re located in the Baton Rouge area, you might be wondering: Can I get delivery to the Baton Rouge area? And while we’re not offering delivery just yet, we do offer pick-up for our BookOnePos Baton Rouge customers. You can pick up your meals at our Perkins Road East location. Our BookOnePos Baton Rouge orders are available for pick up every Sunday and Wednesday every week after 12:00 PM. If you’d like more information about the BookOnePos Baton Rouge operation, please give us a call.</p>
